...
/**
 * Deterministic homepage event selection:
 * - visible, bettable events in a
 * live/upcoming state,
 * - ordered by `display_order` then numeric id, capped to
 * `limit`.
 * - Pure and side-effect free — unit-testable without network access.
 */
